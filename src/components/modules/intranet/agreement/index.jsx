...
import Galery from './../../../render/intranet/agreement/index/galery';

import Utils from '../../../../utils/utils';

import ButtonsFloating from '../../../render/intranet/agreement/index/buttons_floating';
import Check_mode from '../../../render/intranet/agreement/index/check_mode'
import MiniGalery from '../../../render/intranet/agreement/index/mini_galery';

import '../../../../sass/modules/intranet/agreement/index.sass';

class AgreementsIndex extends Component {
    constructor(){
        super();
        this.state = {
            update_galery : 0,
    ...
    render() {
        return (
            <div className="agreement_index">
                <Header selected="agreement"/>
    ...
    createSponsor(){
        this.utils.doQuery("/intranet/agreement/create")
        .then((response)=>{//json
    ...
    deleteSponsors(){
        ...
        this.utils.doQuery("/intranet/agreement/delete",form)
        .then((response)=>{
            if(response){
                this.setState({
                    array_Ids : []
