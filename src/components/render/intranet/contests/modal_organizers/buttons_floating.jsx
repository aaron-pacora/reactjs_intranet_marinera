...
// import './../../../../../sass/render/intranet/contests/modal_organizers/buttons_floating.sass';
...
class ButtonsFloating extends Component {
    constructor(props){
        ...
        this.createOrganizer = this.props.createOrganizer;
        this.deleteOrganizers = this.props.deleteOrganizers;
