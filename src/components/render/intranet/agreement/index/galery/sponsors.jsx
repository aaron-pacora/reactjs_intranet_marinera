...
class Sponsor extends Component {
            ...
            <div className="sponsor" 
                ...
                <div className="content_img z-depth-3" 
                    ...
                    <img  className="img" 
                        ...
                        src={
                            ...
                            global.URBBASERESOURCE+"/agreements/"+this.clearIdUUID(this.state.id)+this.state.src
                            :""    
                        } 
                ...
                <div className="url-buttons">
                    ...
                    <TextArea id        = "description"
                              ...
                              onChange  = {this.onChange}
                              className = "input" />
                    <div className="url-buttons-last">
                        <Input id       = "link"
                               name     = "link"
                               type     = "text"
                               label    = "Link del convenio"
    ...
    updateSponsor(){
        ...
        if (!validator.isURL(link, { protocols: ['https', 'http'], require_protocol: true })){
        ...
        this.utils.doQuery("/intranet/agreement/update", form)
        .then((response)=>{
