...
// import '../../../../../../sass/render/intranet/sponsors/index/mini_galery/img_sponsor.sass';
    ...
    render() {
        return (
            <div className="content_img z-depth-3"
                ...
                <img src={global.URBBASERESOURCE+"/sponsors/"+this.clearIdUUID(this.state.id)+this.state.src} 
